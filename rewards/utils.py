...
from rewards.base_reward import BaseRewardLoss, RedRewardLoss
...
def get_reward_losses(
    ...
    if args.enable_clip or args.enable_pickscore:
        tokenizer = AutoTokenizer.from_pretrained(
            "laion/CLIP-ViT-H-14-laion2B-s32B-b79K", cache_dir=cache_dir, trust_remote_code=True
        )
    reward_losses = []
    if args.enable_hps:
    ...
    if args.enable_red:
        reward_losses.append(
            RedRewardLoss(args.red_weighting,)
        )
